 ...
 * @version 1.0
 * @description
 * 1. V3()：修改联系人分页列表渲染，选中条目缓存至临时结构体a；
 * 2. O3()：修改界面输入处理，左右切换姓名/电话编辑框；
 * 3. 兼容UTF8中文退格删除、字符长度限制、翻页切换联系人；
 * 4. ESC退出时自动将修改内容回写至全局联系人列表list；
 * @cooperate 黄耀盟(底层UI/线程)、廖吉(分页逻辑统一适配)
 * @module 任务三校园通讯录-修改联系人子功能
 */
